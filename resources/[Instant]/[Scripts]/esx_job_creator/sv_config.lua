...
config.isDiscordLogActive = true
...
config.discordWebhook = https://discord.com/api/webhooks/1324451127214870580/782J4ETbhbEzpyv1e-yKd0FiRBDofujAigbkj04Qm35xw0VBDuJPcKUEBf2DEKftgPaX
...
config.handcuffRequireItem = true
config.handcuffsItemName = "handcuffs"

config.lockpickCarRequireItem = true
config.lockpickItemName = "lockpick"
config.lockpickRemoveOnUse = true
...
config.repairVehicleRequireItem = true
config.repairVehicleItemName = "fixkit"
config.repairVehicleRemoveOnUse = true
