...
Config.Arcade = {
    {
        NPC = {
            position = vector3(590.312, 2747.5, 40.908),
            heading = 274.221,
            model = "ig_claypain",
        },
        blip = {
            position = vector3(590.312, 2747.5, 41.908),
            blipId = 521,
            scale = 1.0,
            color = 0,
            name = "Dave & Busters",
        ...
        marker = {
            markerPosition = vector3(592.237, 2747.439, 41.912),
            markerType = 23,
            options = {
...
Config.computerList = {
    -- Retro machines
    {
        ...
        markerType = 31,
        position = vector3(581.946, 2776.757, 41.93),
        markerOptions = {
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 31,
        position = vector3(601.326, 2749.013, 41.945),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 255, g = 255, b = 255, a = 125 },
            rotate = true,
    ...
    -- Gaming computers
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 42,
        position = vector3(581.421, 2772.425, 41.905),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
