...
Citizen.CreateThread(function()
    while true do
		...
		if IsPedInAnyVehicle(player, true) and not IsPauseMenuActive() and IsVehicleEngineOn(GetVehiclePedIsIn(player, false)) then 
...
RegisterCommand("togcompass", function()  
