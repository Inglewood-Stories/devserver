...
ESX.RegisterCommand('carfix', {'admin', 'leadadmin', 'management'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('skin', {'admin', 'leadadmin', 'management'}, function(xPlayer, args, showError)
