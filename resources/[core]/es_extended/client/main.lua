...
RegisterNetEvent('esx:fix')
AddEventHandler('esx:fix', function()
	...
	if IsPedInAnyVehicle(playerPed, false) then
		...
		exports['dlrms_notify']:SendAlert('inform', 'Vehicle has been fixed')
	else
		exports['dlrms_notify']:SendAlert('error', 'You\'re not in a vehicle! There is no vehicle to fix!')
	end
end)