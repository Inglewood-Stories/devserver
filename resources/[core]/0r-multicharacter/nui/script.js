...
$(document).ready(function () {
  ...
  $(document).on("click", "#spawn-play", function () {
    $.post(
      "https://0r-multicharacter/SpawnPed",
      JSON.stringify({
  ...
  setupLocations = (locations, houses, isNew) => {
    ...
    // $.post("https://0r-multicharacter/setCam", JSON.stringify({
  ...
  $(document).on("click", ".spawn-location", function () {
    ...
    $.post(
      "https://0r-multicharacter/setCam",
      JSON.stringify({
        location: currentLocation.id,
        type: currentLocation.type,
      })
  ...
  const loadCharMenu = (data) => {
    ...
    $.post(
      "https://0r-multicharacter/SetPedAction",
      JSON.stringify({
        data: currentChar,
      })
    );
  ...
  $(document).on("click", "#play-game", function () {
    $.post(
      "https://0r-multicharacter/PlayGame",
      JSON.stringify({
        data: currentChar,
      }),
      function (res) {
        if (res) {
          ...
          $(".character-slot-contain").slideUp(500);
          setTimeout(() => {
            $.post("https://0r-multicharacter/CloseUI", JSON.stringify({}));
          }, 10);
        }
      }
    );
  ...
  $(document).on("click", ".confirm-delete", function () {
    $.post(
      "https://0r-multicharacter/DeleteCharacter",
      JSON.stringify({
  ...
  $(document).on("click", "#create-char", function () {
    ...
    $.post(
      "https://0r-multicharacter/CreateCharacter",
      JSON.stringify({
        firstname: firstname,
        lastname: lastname,
        birthdate: birthdate,
  ...
  $(document).on("click", ".confirm-buying", function () {
    ...
    $.post(
      "https://0r-multicharacter/CheckCode",
      JSON.stringify({
        code: inputValue,
        cid: currentCidId,
      }),
  ...
  $(document).on("click", ".gn", function () {
    ...
    $.post(
      "https://0r-multicharacter/ChangeGender",
      JSON.stringify({
