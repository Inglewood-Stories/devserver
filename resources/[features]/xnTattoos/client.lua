...
AddEventHandler('fivem-appearance:barberMenu', function()
...
AddEventHandler('fivem-appearance:clothingShop', function()
	ESX.TriggerServerCallback('SmallTattoos:GetPlayerTattoos', function(tattooList)
		if tattooList then
			ClearPedDecorations(PlayerPedId())
			for k, v in pairs(tattooList) do
...
AddEventHandler('fivem-appearance:clothingMenu', function()
	ESX.TriggerServerCallback('SmallTattoos:GetPlayerTattoos', function(tattooList)
		if tattooList then
			ClearPedDecorations(PlayerPedId())
			for k, v in pairs(tattooList) do
...
AddEventHandler('fivem-appearance:surgeryMenu', function()
	ESX.TriggerServerCallback('SmallTattoos:GetPlayerTattoos', function(tattooList)
		if tattooList then
			ClearPedDecorations(PlayerPedId())
			for k, v in pairs(tattooList) do
...
function GetNaked()
	TriggerEvent('esx_skin:getPlayerSkin', function()
...
function ResetSkin()
	ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
		--TriggerEvent('psa_clothes:LoadYourClothes', skin)
	end)
	ClearPedDecorations(PlayerPedId())
	for k, v in pairs(currentTattoos) do
		if v.Count ~= nil then
