CREATE TABLE `JAM_vehicle_categories` (
...
INSERT INTO `JAM_vehicle_categories` (name, label) VALUES
  ('compacts','Compacts'),
  ('coupes','Coupés'),
  ('sedans','Sedans'),
  ('sports','Sports'),
...
INSERT INTO `JAM_vehicles` (name, model, price, category, inshop) VALUES
